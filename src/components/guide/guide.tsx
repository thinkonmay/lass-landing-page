        ...
        return (
            <div className={reverse ? 'rowGuide reverse' : 'rowGuide'}>
                ...
                >
                    ...
                    <div
                        className={
                            reverse ? 'decoration reverse' : 'decoration'
                        }
                    ></div>
                </ul>
                <div className="icon">
            ...
            <div className="guide">
                <div className="mainContent grid wide">
                    <div className="title l-8 m-12 c-12 ">
                        ...
                        <p>
                            Cảm ơn bạn đã tin tưởng & lựa chọn sản phẩm - dịch
                            vụ tại Thinkmay. Chúng tôi sẽ cố gắng giúp bạn có
                            được những sản phẩm tốt nhất với thời gian nhanh
                            nhất.
                        </p>
                    </div>
