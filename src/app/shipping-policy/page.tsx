			...
			<div className='shippingPolicy '>
				<div className="mainContent grid wide">
					<div className='title l-8'>
						...
						<p>
							Thinkmay hỗ trợ vận chuyển sản phẩm đến tất cả các tỉnh thành trên toàn lãnh thổ Việt Nam. 
							Khách hàng nếu có nhu cầu mua hàng, 
							vui lòng lưu ý các điều khoản sau.
						</p>
					</div>
					...
					<div className="wrapperPolicys">
						{
							policys.map(plc => (
								<Content category={plc.category} contents={plc.contents}></Content>
							))
						}
					</div>
				</div>
